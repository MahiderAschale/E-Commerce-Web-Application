        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-6 md:mb-0">
              <img src="/1.jpg" alt="Model wearing discounted items" className="w-full h-auto" />
            </div>
          ...
          <div className="relative overflow-hidden">
            <img src="/1.jpg" alt="Winter collection" className="w-full h-auto " />
            <div className="absolute inset-0 bg-black bg-opacity-30 flex flex-col justify-center p-8 text-yellow-500">
              <h3 className="text-3xl font-bold mb-2"> Made for your moment—</h3>
              <p className="mb-4"> Discover pieces that bring confidence, comfort, and character to your everyday style.</p>
